...
需要注意的是选择型号为13t下载的即为COS,而选择13s下载的即为OOS
...
⚠️ **注意事项**：若需要euicc和谷歌助手唤醒，需对OOS进行一次如上操作，即再解包一个payload.img，如对该注意事项不理解，请问ai
...
返回源码根目录：
在编译前请注释`hardware/oplus/sepolicy/qti/vendor/genfs_contexts`中的
```bash
...
<div align="center">
⚠️⚠️⚠️⚠️以下操作为选修⚠️⚠️⚠️⚠️<br>
⚠️⚠️⚠️⚠️以下操作为选修⚠️⚠️⚠️⚠️<br>
⚠️⚠️⚠️⚠️以下操作为选修⚠️⚠️⚠️⚠️<br>
⚠️⚠️⚠️⚠️以下操作为选修⚠️⚠️⚠️⚠️<br>
⚠️⚠️⚠️⚠️以下操作为选修⚠️⚠️⚠️⚠️
</div>
